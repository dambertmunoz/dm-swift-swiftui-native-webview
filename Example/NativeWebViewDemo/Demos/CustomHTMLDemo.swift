...
struct CustomHTMLDemo: View {
    ...
    private let templates: [HTMLTemplate] = [
        HTMLTemplate.welcomeCard,
        HTMLTemplate.dataDashboard,
        HTMLTemplate.interactiveForm
    ]
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            // Description
            Text(templates[selectedTemplate].description)
                .font(.caption)
...
struct HTMLTemplate {
    ...
    static let welcomeCard = HTMLTemplate(
        name: "Welcome",
        description: "Gradient card with centered content",
        html: """
        <!DOCTYPE html>
        <html>
        <head>
    ...
    static let dataDashboard = HTMLTemplate(
        name: "Dashboard",
        description: "Dark theme data dashboard",
        html: """
        <!DOCTYPE html>
        <html>
        <head>
    ...
    static let interactiveForm = HTMLTemplate(
        name: "Form",
